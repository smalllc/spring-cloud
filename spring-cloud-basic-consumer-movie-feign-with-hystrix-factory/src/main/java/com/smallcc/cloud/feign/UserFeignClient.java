...
import com.smallcc.cloud.feign.impl.HystrixClientFactoryFallback;
 ...
 */
@FeignClient(name = "spring-cloud-basic-provider-user" ,/*fallback = HystrixClientFallback.class,*/fallbackFactory = HystrixClientFactoryFallback.class)
