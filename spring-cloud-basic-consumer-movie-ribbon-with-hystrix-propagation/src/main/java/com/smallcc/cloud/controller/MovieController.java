...
public class MovieController {
  ...
  @GetMapping("/movie/{id}")
  // @HystrixCommand(fallbackMethod = "findByIdFallback",commandProperties = {@HystrixProperty(name = "execution.isolation.strategy",value = "SEMAPHORE")}) // 抛异常的时候使用
  @HystrixCommand(fallbackMethod = "findByIdFallback") // 官方文档推荐使用
